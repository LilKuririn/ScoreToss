...
fr:{
  ...
  "app.desc":"Compteur de points pour les jeux d'extérieur, d'intérieur et de société. Cornhole, palet breton, mölkky, bibock, fléchettes et yams, en simple, en double ou en équipes, tournois à élimination directe et palmarès entre joueurs.",
...
en:{
  ...
  "app.desc":"A score keeper for outdoor, indoor and board games. Cornhole, Breton palet, Mölkky, Bibock, darts and Yams, singles, doubles or teams, single-elimination tournaments, and a record of who beats whom.",
...
es:{
  ...
  "app.desc":"Marcador de puntos para juegos de exterior, de interior y de mesa. Cornhole, palet bretón, mölkky, bibock, dardos y yams, individual, por parejas o por equipos, torneos de eliminación directa e historial de enfrentamientos.",
