...
fr:{
  ...
  "pl.rank":"Classement, tous jeux", "pl.list":"Le carnet",
  "pl.fiche.aria":"Fiche de {name}", "pl.played":"Parties", "pl.bygame":"Par jeu",
  "pl.count.games":"{n} partie","pl.count.games_p":"{n} parties",
  "pl.won":"gagnée", "pl.lost":"perdue",
  "pl.nogame":"Aucune partie enregistrée pour ce joueur. Choisissez son nom au départ d'une partie et elle comptera ici.",
  "pl.del":"Supprimer ce joueur", "pl.del.ok":"Confirmer la suppression",
  "hall.w2":"Victoires",
...
en:{
  ...
  "pl.rank":"Standings, all games", "pl.list":"Your players",
  "pl.fiche.aria":"{name}’s record", "pl.played":"Games", "pl.bygame":"By game",
  "pl.count.games":"{n} game","pl.count.games_p":"{n} games",
  "pl.won":"won", "pl.lost":"lost",
  "pl.nogame":"No games recorded for this player yet. Pick their name when starting a game and it will count here.",
  "pl.del":"Delete this player", "pl.del.ok":"Confirm deletion",
  "hall.w2":"Wins",
...
es:{
  ...
  "pl.rank":"Clasificación, todos los juegos", "pl.list":"Tus jugadores",
  "pl.fiche.aria":"Ficha de {name}", "pl.played":"Partidas", "pl.bygame":"Por juego",
  "pl.count.games":"{n} partida","pl.count.games_p":"{n} partidas",
  "pl.won":"ganada", "pl.lost":"perdida",
  "pl.nogame":"Ninguna partida registrada para este jugador. Elige su nombre al empezar una partida y contará aquí.",
  "pl.del":"Eliminar este jugador", "pl.del.ok":"Confirmar la eliminación",
  "hall.w2":"Victorias",
