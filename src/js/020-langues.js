...
fr:{
  ...
  "mk.turn":"À {name}",
  "mk.miss":"Raté",
  "mk.throw.aria":"{name} marque {n} point","mk.throw.aria_p":"{name} marque {n} points",
  "mk.miss.aria":"{name} manque son lancer",
  "mk.out":"Éliminé",
  "mk.misses":"{n} raté de suite","mk.misses_p":"{n} ratés de suite",
...
en:{
  ...
  "mk.miss":"Miss",
  "mk.throw.aria":"{name} scores {n} point","mk.throw.aria_p":"{name} scores {n} points",
  "mk.miss.aria":"{name} misses",
  "mk.out":"Out",
  "mk.misses":"{n} miss in a row","mk.misses_p":"{n} misses in a row",
...
es:{
  ...
  "mk.miss":"Fallo",
  "mk.throw.aria":"{name} anota {n} punto","mk.throw.aria_p":"{name} anota {n} puntos",
  "mk.miss.aria":"{name} falla el lanzamiento",
  "mk.out":"Eliminado",
  "mk.misses":"{n} fallo seguido","mk.misses_p":"{n} fallos seguidos",
